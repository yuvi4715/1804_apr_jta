...
var TestComponent = /** @class */ (function () {
    ...
    TestComponent.prototype.setHandler = function (receipt, user) {
        console.log(user);
    ...
    TestComponent.prototype.onAprove = function (receipt) {
        ...
        this._databaseService.postReinbursementRequest(receipt.id, receipt.status).subscribe(function (data) {
            console.log(data);
            _this.setHandler(receipt, _this._databaseService.user);
        }, function (error) { });
    };
