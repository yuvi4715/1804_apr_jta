package myConnectionUtil;
	...
	public class ConnectionsWithPropertiesUtil {
		...
		public static Connection getConnection() {
			...
			//return DriverManager.getConnection("jdbc:oracle:thin:@jta1804.cxgdxavzpy7e.us-east-2.rds.amazonaws.com:1521:ORCL",
	            //		"lucynwosu","glogracmike12");		
