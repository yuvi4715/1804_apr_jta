...
var a = "Hello world!";
console.log(a);
print_variables();			//example for hoisting - call a function before its definition
...
//variable is declared inside a function.it is function scope or also called as local scope

//diff between var and let
var i = 10;
//testing to see if the variable declared with var is accessible outside if block
if (i ===10 ){
	var variableDefinedWithVar = "checking for block scope - var";
}
console.log("variableDefinedWithVar: " + variableDefinedWithVar);

//testing to see if the variable declared with let is accessible outside if block
if (i ===10 ){
...
////null and undefined are not equal to anything except for themselves and each other
